        ...
        if (isset($_POST['cliente_id'], $_POST['curso_id'])) {
            ...
            if (!empty($id_registro)) {
                ...
                if ($this->model->modificar_registro($registro)) {
                    // Nota: Asegúrate de que el parámetro "accion" sea el correcto. 
                    // En el de guardado nuevo usaste "registros_capacitacion" y aquí "registros".
            ...
            $this->manejarError("Faltan datos obligatorios del formulario");
        }
    }
