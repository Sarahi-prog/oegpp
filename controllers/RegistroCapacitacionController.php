...
class RegistroCapacitacionController{
    ...
    public function guardar(){
        try {
            if(isset($_POST['trabajador_id']) && isset($_POST['curso_id']) && isset($_POST['libro_id']) && isset($_POST['registro']) && isset($_POST['horas_realizadas']) && isset($_POST['fecha_emision']) && isset($_POST['folio'])){
                $registrocapacitacion = new RegistroCapacitacion();
                $registrocapacitacion->setTrabajadorId($_POST['trabajador_id']);
