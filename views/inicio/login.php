...
<body>
    <div class="container">
        <header class="header">
            ...
            <nav class="nav">
                ...
                <a href="index.php?accion=trabajadores">Sistema</a>
        ...
        <section class="hero">
            <div class="hero-content">
                ...
                <p class="hero-description">
                    Gestiona trabajadores, cursos de capacitación y certificaciones profesionales.
        ...
        <section class="features" id="features">
            <div class="feature-card">
                ...
                <p>Administra el registro completo de trabajadores, asigna cursos de capacitación,
            ...
            <div class="feature-card">
                ...
                <p>Gestiona cursos, módulos y certificaciones. Asigna capacitaciones a trabajadores,
                ...
                <div class="modal-body">
                    ...
                    <form id="loginForm">
                        ...
                        <div class="register-link" style="margin-top: 15px; text-align: center;">
                            ...
                            <button type="button" id="registerUserBtn" class="btn-login" style="margin-top: 10px; width: 100%; background: linear-gradient(135deg, #27ae60 0%, #229954 100%);">
                                <i class="fas fa-user-plus"></i> Solicitar Registro
                            </button>
                            <p style="margin-top: 10px; font-size: 12px; color: #7f8c8d;">
                                ¿Eres Administrador?
                                <a href="#" id="openRegisterAdminBtn" style="color: #27ae60; text-decoration: none; font-weight: 600; transition: color 0.3s ease;">
                                    Registrate aquí
                                </a>
                            </p>
                        </div>
        ...
        <div id="registerAdminModal" class="modal">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div id="registerAlertMessage" class="alert-message"></div>
                    <form id="registerAdminForm">
                        <div class="form-group">
                            <label>Nombre completo</label>
                            <div class="input-wrapper">
                                <i class="fas fa-user"></i>
                                <input type="text" id="reg_nombre" name="reg_nombre" placeholder="Nombre completo" required>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-wrapper">
                                ...
                                <input type="email" id="reg_email" name="reg_email" placeholder="correo@ejemplo.com" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <label>Usuario</label>
                            <div class="input-wrapper">
                                ...
                                <input type="text" id="reg_usuario" name="reg_usuario" placeholder="Nombre de usuario" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <label>Contraseña</label>
                            <div class="input-wrapper">
                                <i class="fas fa-lock"></i>
                                <input type="password" id="reg_password" name="reg_password" placeholder="Contraseña" required>
                                <i class="fas fa-eye toggle-password" onclick="toggleRegisterPassword('reg_password', this)"></i>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-wrapper">
                                <i class="fas fa-lock"></i>
                                <input type="password" id="reg_confirm_password" name="reg_confirm_password" placeholder="Repite la contraseña" required>
                                <i class="fas fa-eye toggle-password" onclick="toggleRegisterPassword('reg_confirm_password', this)"></i>
                            </div>
                        </div>
                        <button type="submit" class="btn-login" style="background: linear-gradient(135deg, #f39c12 0%, #e67e22 100%);">
        ...
        <footer class="footer">
            <div style="display: flex; justify-content: center; align-items: center; gap: 20px; flex-wrap: wrap;">
                ...
                <div style="display: flex; gap: 15px;">
                    <a href="#" style="color: #27ae60; text-decoration: none; transition: color 0.3s ease;">
            ...
            <p style="margin-top: 10px; font-size: 12px; opacity: 0.7;">
                Todos los derechos reservados • Desarrollado con <i class="fas fa-heart" style="color: #e74c3c;"></i> para la excelencia profesional
            </p>
        </footer>
    </div>
    ...
    <script>
        ...
        // Manejo del botón de registro de usuario
        ...
        // Manejo del botón de registro de administrador
        document.getElementById('openRegisterAdminBtn').addEventListener('click', function(e) {
            e.preventDefault();
            ...
            // Abrir modal de registro de admin
            registerAdminModal.classList.add('show');
            registerAdminModal.style.display = 'flex';
        });
    </script>
</body>
