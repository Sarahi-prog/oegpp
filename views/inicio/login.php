...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (showLoginBtn) {
            showLoginBtn.addEventListener('click', () => modal.style.display = 'flex');
        }
        if (closeModalBtn) {
        ...
        if (loginForm) {
            loginForm.addEventListener('submit', async function(e) {
                ...
                try {
                    ...
                    if (!response.ok) {
                        throw new Error('No se encontró el procesador de login (Error 404). Verifica la ruta.');
                    }
                    ...
                    if (data.success) {
                        ...
                        setTimeout(() => {
                            window.location.href = 'index.php?accion=trabajadores';
                        }, 1500);
                    } else {
                        alertMessage.textContent = data.message;
