...
<body>
    ...
    <div class="hero-banner">
        ...
        <div class="container hero-content">
            <div class="hero-text">
                ...
                <p class="hero-subtitle">Administra clientes, cursos, diplomados y certificaciones desde un solo lugar.</p>
    ...
    <div class="container main-content">
        ...
        <div class="stats-grid">
            ...
            <div class="stat-card" onclick="window.location.href='index.php?accion=clientes'" style="cursor: pointer;">
            ...
            <div class="stat-card">
                ...
                <div class="stat-body">
                    ...
                    <p class="stat-value"><?php echo $datos['certificaciones'] ?? 0; ?></p>
                    <p class="stat-trend orange"><i class="fas fa-arrow-trend-up"></i> Tipo: certificados</p>
                </div>
            </div>
            ...
            <div class="stat-card">
                ...
                <div class="stat-body">
                    ...
                    <p class="stat-value"><?php echo $datos['diplomas'] ?? 0; ?></p>
                    <p class="stat-trend purple"><i class="fas fa-arrow-trend-up"></i> Tipo: diplomados</p>
                </div>
            </div>
    ...
    <script src="public/UniversalScript.js?v=<?php echo time(); ?>"></script>
    <script src="public/clientesScript.js?v=<?php echo time(); ?>"></script>
