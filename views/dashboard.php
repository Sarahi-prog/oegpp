    ...
    <div class="container main-content">
        ...
        <div class="stats-grid">
            ...
            <?php if (isset($_SESSION['admin_general']) && $_SESSION['admin_general'] === true): ?>
                <div class="stat-card" onclick="window.location.href='index.php?accion=autorizacionUsuarios'" style="cursor: pointer;">
                    <div class="stat-header" style="background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%);">
                        <div class="stat-bg"></div>
                        <div class="stat-icon-wrapper"><i class="fas fa-user-check"></i></div>
                    </div>
                    <div class="stat-body">
                        <p class="stat-label">Autorizar Usuarios</p>
                        <p class="stat-value">Gestionar solicitudes <i class="fas fa-arrow-right" style="font-size: 1rem; margin-left: 5px;"></i></p>
                    </div>
                </div>
            <?php endif; ?>
